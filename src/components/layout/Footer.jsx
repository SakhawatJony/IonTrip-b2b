...
import paymentmethodes from "../../../src/assets/Home/fotter/paymentmethode.png";
import facebook from "../../../src/assets/Home/fotter/facebook.png";
import linkdin from "../../../src/assets/Home/fotter/linkdin.png";
import twiter from "../../../src/assets/Home/fotter/twitur.png";

const Footer = () => {
  return (
    <Box sx={{ bgcolor: "#ffffff", borderTop: "1px solid #eaeaea" }}>
      {/* TOP BAR */}
