...
// Tour table columns (same layout style as agent flight / hotel booking)
const tableColumns = [
  { key: "bookingId", label: "Booking Id", width: "100px" },
  { key: "guest", label: "Guest", width: "120px" },
  { key: "tourName", label: "Tour Name", width: "140px" },
  { key: "startDate", label: "Start Date", width: "90px" },
  { key: "endDate", label: "End Date", width: "90px" },
...
const TourBookingsPage = ({
  title = "Tour All Bookings",
  viewMode = "all",
  emptyLabel = "No tour bookings found",
}) => {
